...
def getEggMoves(pokemon):
    ...
    moves = soup.find_all('table', class_ = 'data-table')[2]
    moves2 = moves.find_all('a', class_ = 'ent-name')
    for row in moves2:
        row = row.text
        egg_moves.append(row)
